...
from ..nafnet.naf_avgpool2d import Local_Base
from ..nafnet.naf_layerNorm2d import LayerNorm2d

class StereoNAFNetFreqFusion(BaseModule):
    # """NAFNet.
    #
    ...
    def forward(self, left, right):
        pred_left = self.forward_single(left)
        pred_right = self.forward_single(right)
        return pred_left, pred_right

    def forward_single(self, inp):
        """Forward function.
...
class NAFNetLocal(Local_Base, StereoNAFNet):
