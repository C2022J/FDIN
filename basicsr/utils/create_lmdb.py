...
def create_lmdb_for_gopro():
    ...
    folder_path = './datasets/GoPro/test_V2/target'
    lmdb_path = './datasets/GoPro/test_V2/target.lmdb'

    img_path_list, keys = prepare_keys(folder_path, 'png')
    make_lmdb_from_imgs(folder_path, lmdb_path, img_path_list, keys)

    folder_path = './datasets/GoPro/test_V2/input'
    lmdb_path = './datasets/GoPro/test_V2/input.lmdb'
